...
inline namespace {
  ...
  inline namespace LegacyStringGettersAndSetters { // This just helps folding / hiding these functions
    ...
    String getPaletteMode(){
      return String(autoPaletteMode);
    }
  ...
  const Field fields[] = {
      ...
      {"autoPaletteMode",          "Palette Mode",           Field_t::Boolean,   0,            1, getPaletteMode,nullptr,     nullptr},
      {"palette",              "Palette",                Field_t::Select,    0, paletteCount, getPalette,    getPalettes, nullptr},
      {"speed",                "Speed",                  Field_t::Number,    0,           30, getSpeed,      nullptr,     nullptr},
